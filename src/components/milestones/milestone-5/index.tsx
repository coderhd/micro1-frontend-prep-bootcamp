...
export function Milestone5Page () {
	...
	return (
		<div className="flex flex-col gap-6 animate-fadeIn">
			{/* Hero Header */}
			<div className="rounded-2xl border border-purple-500/40 bg-gradient-to-r from-surface-900 via-surface-900 to-purple-950/40 p-6 backdrop-blur-md shadow-xl shadow-purple-500/10">
				<div className="flex flex-wrap items-center justify-between gap-4 mb-2">
					...
					<span className="text-xs text-purple-300 font-semibold bg-purple-500/10 border border-purple-500/20 px-2.5 py-0.5 rounded-full">
						Simulated micro1 AI Recruiter Call
					</span>
				</div>

				<h1 className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight flex items-center gap-2.5">
					<Bot className="h-8 w-8 text-pink-400" />
					<span>The &quot;Zara&quot; AI Recruiter Mock Interview</span>
				</h1>
				<p className="text-sm text-slate-300 mt-1 max-w-3xl leading-relaxed">
					Put all your frontend knowledge and RL data benchmark reasoning to the test in a realistic, timed conversational interview with micro1&apos;s AI recruiter.
				</p>
				...
				<div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-6 border-t border-surface-800 pt-4">
					<div className="rounded-xl bg-surface-950/80 border border-surface-800 p-3">
						...
						<p className="text-[11px] text-slate-400">
							Features Web Speech API for Zara voice readout and voice-to-text input.
						</p>
					</div>
					...
					<div className="rounded-xl bg-surface-950/80 border border-surface-800 p-3">
						<div className="flex items-center gap-2 text-xs font-bold text-emerald-300 mb-1">
							...
							<span>Automated Rubric Scoring</span>
						</div>
						<p className="text-[11px] text-slate-400">
							Evaluates technical keywords, architectural depth, and edge-case handling.
						</p>
					</div>
					...
					<div className="rounded-xl bg-surface-950/80 border border-surface-800 p-3">
						<div className="flex items-center gap-2 text-xs font-bold text-purple-300 mb-1">
							...
							<span>Detailed Report Card</span>
						</div>
						<p className="text-[11px] text-slate-400">
							Generates actionable hiring recommendations and strengths/gaps summary.
						</p>
					</div>
				</div>
				...
				<div className="mt-6 flex flex-wrap items-center justify-between gap-4 border-t border-surface-800 pt-4">
					<div className="flex items-center gap-2 text-xs text-slate-400">
						...
						<span>You can type or speak your answers. You can pause or exit anytime.</span>
					</div>

					<button
						onClick={handleStartInterview}
						className="flex items-center gap-2.5 rounded-xl bg-gradient-to-r from-purple-600 via-pink-600 to-indigo-600 hover:brightness-110 px-6 py-3 text-sm font-bold text-white shadow-xl shadow-purple-500/25 transition active:scale-98"
					>
						<Play className="h-4 w-4 fill-current" />
						<span>Launch Zara AI Interview Simulation</span>
					</button>
				</div>
			</div>
						...
						{interviewReports.map((rep, idx) => (
							...
							>
								<div className="flex items-center gap-3">
									<div className="flex h-8 w-8 items-center justify-center rounded-lg bg-purple-500/20 text-purple-400 font-bold text-xs">
